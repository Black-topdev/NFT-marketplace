...
contract Unifty is ERC1155Tradable {
    ...
    string private _contractURI = "https://geospatial-nft-market-place.web.app.io/meta/contract.json";

	constructor(address _proxyRegistryAddress) public ERC1155Tradable("GeospatialNFT", "GNFT", _proxyRegistryAddress) {
		_setBaseMetadataURI("https://geospatial-nft-market-place.web.app/meta/");
	}
